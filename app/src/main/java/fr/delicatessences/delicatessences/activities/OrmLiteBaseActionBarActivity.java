 ...
 * {@link com.j256.ormlite.support.ConnectionSource}.
 *
 * The method {@link #getHelper()} assumes you are using the default helper factory -- see {@link com.j256.ormlite.android.apptools.OpenHelperManager}. If
...
public abstract class OrmLiteBaseActionBarActivity<H extends OrmLiteSqliteOpenHelper> extends AppCompatActivity {
    ...
    private static final Logger logger = LoggerFactory.getLogger(OrmLiteBaseActivity.class);
