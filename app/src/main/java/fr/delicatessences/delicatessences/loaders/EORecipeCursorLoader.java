...
public class EORecipeCursorLoader<D> extends AsyncTaskLoader<Cursor> {
    ...
    public Cursor loadInBackground() {
        ...
        if (mActivity instanceof OrmLiteBaseActionBarActivity) {
            try {
                ...
                PreparedQuery<Recipe> preparedQuery = helper.prepareRecipeQuery(mId);
...
// An async query came in while the loader is stopped
    ...
    public EORecipeCursorLoader(Context context, int id) {
        super(context);
        mActivity = context;
