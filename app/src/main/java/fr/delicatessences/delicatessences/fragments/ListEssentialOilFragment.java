...
import fr.delicatessences.delicatessences.loaders.EssentialOilCursorLoader;

public class ListEssentialOilFragment extends Fragment
        implements LoaderManager.LoaderCallbacks<Cursor>, Reloadable {

    private final static String LIST_STATE_KEY = "scrollPosition";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new OilListCursorAdapter(activity, ViewType.ESSENTIAL_OILS);
        ...
        if (mOnlyFavorites){
            ...
            message = resources.getString(R.string.how_to_add_essential_oil_favorite);
        }else{
            title = resources.getString(R.string.no_essential_oil);
            message = resources.getString(R.string.how_to_add_essential_oil);
        }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (actionBar != null){
            ...
            actionBar.setTitle(titles[ViewType.ESSENTIAL_OILS.ordinal()]);
        }
    ...
    public static ListEssentialOilFragment newInstance(boolean onlyFavorites) {
        ListEssentialOilFragment fragment = new ListEssentialOilFragment();

        Bundle args = new Bundle();
        args.putBoolean(MainActivity.EXTRA_ONLY_FAVORITES, onlyFavorites);
        args.putInt(MainActivity.EXTRA_VIEW_TYPE, ViewType.ESSENTIAL_OILS.ordinal());
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        return new EssentialOilCursorLoader(getActivity(), mOnlyFavorites);
    }
